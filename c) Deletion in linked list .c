...
int main(){
  ...
  head = DeleteEnd(head);//for deleting the end element
...
//Deletion at particular given value
struct Node *DeleteAtValue(struct Node *head, int value){
  ...
  if(q ->data == value){
    ...
    printf("Value couldn't find to delete\n");
  }
...
int main(){
  ...
  head = DeleteAtValue(head,66);//for deleting at particular value
